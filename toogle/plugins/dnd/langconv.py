...
from toogle.plugins.dnd.zh_wiki import zh2Hant, zh2Hans
...
if py3k:
    ...
    for old, new in ((zh2Hant, _zh2Hant), (zh2Hans, _zh2Hans)):
        for k, v in old.items():
            new[k.decode("utf8")] = v.decode("utf8")  # type: ignore
    zh2Hant = _zh2Hant
    zh2Hans = _zh2Hans
    UEMPTY = "".decode("utf8")  # type: ignore
