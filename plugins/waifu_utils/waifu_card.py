...
from plugins.waifu_utils.waifu_random import text_on_image, buffered_url_pic, max_resize
...
def get_waifu_card(
    ...
    desc: str,
    cv: str,
    font_path: str = 'tools/fonts/FangZhengKaiTi-GBK-1.ttf',
    is_new: bool = True,
    is_female: bool = True,
    waifu_score: float = 0,
    waifu_rank: str = '',
...
if __name__ == "__main__":
    from plugins.waifu.waifu import get_random_anime_character # type: ignore
