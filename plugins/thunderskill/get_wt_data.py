...
tech_tree = json.loads((RESOURCE_DIR / "vehicle_tree.json").read_text(encoding="utf-8"))
vehicle_price = json.loads((RESOURCE_DIR / "vehicle_price.json").read_text(encoding="utf-8"))
