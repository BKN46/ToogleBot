...
from toogle.message import Image, Plain, MessageChain
from toogle.message_handler import MessageHandler, MessagePack
from toogle.utils import handle_TLE, set_timeout
from plugins.compose.wolfram_alpha import get_wolfram_alpha_query
...
class FastFallCal(MessageHandler):
    ...
    trigger = rf"^(([1-9]\d*\.?\d*)|(0\.\d*[1-9]))({unit_reg_str})掉落$" # type: ignore
    white_list = False
...
class UnitConversion(MessageHandler):
    ...
    trigger = rf"(([1-9]\d*\.?\d*)|(0\.\d*[1-9]))({trans_reg_str})" # type: ignore
    white_list = False
